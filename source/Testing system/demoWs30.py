...
class Ui_MainWindow(object):
    ...
    def printTxt(self,string):
        ...
        if string[1] > 0.5:
            self.ansLable.setText("Divya")
        else:
            self.ansLable.setText("Not Divya")
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "KeyStroke.io"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; text-decoration: underline;\">KeyStroke.io</span></p></body></html>"))
        ...
        self.ansLable.setText(_translate("MainWindow", "Not divya"))
...
if __name__ == "__main__":
    ...
    MainWindow.show()
    model = keras.models.load_model(r'C:\Users\kusha\OneDrive\Desktop\clg\BioKey-Keystrokes-dynamics-for-continuous-user-authentication-master\BioKey-Keystrokes-dynamics-for-continuous-user-authentication-master\Testing system\1D_2XLSTM32_1x1_Divya_150epochs_WS30.h5')
    sys.exit(app.exec_())
